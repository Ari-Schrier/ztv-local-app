...
from daily_chronicle.audio_generation import generate_audio_tts  # or your TTS function
...
title_slide = generate_title_slide(month, day, generate_audio_tts, test_image_paths)
